...
export default function CollapsibleTable(props) {
  ...
  console.log("apiDataapiDataapiDataapiDataapiData123456", apiData, apiData && apiData.data ? "apiDataapiDataapiDataapiDataapiData456" : "apiDataapiDataapiDataapiDataapiData789")
  const rows = [
    createData({
      id: 1,
